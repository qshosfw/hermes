...
graph LR
    ...
    classDef base fill:#1e1e2e,stroke:#89b4fa,stroke-width:2px,color:white;
    classDef dynamic fill:#1e1e2e,stroke:#a855f7,stroke-width:2px,stroke-dasharray: 5 5,color:white;
    class A,B,C base;
    class D dynamic;
```
