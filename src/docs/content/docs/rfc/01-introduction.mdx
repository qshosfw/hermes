...
graph TD
    ...
    classDef network fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:white
    classDef subnet fill:#1e1e2e,stroke:#6366f1,stroke-width:1px,color:white
    classDef node fill:#111827,stroke:#10b981,stroke-width:2px,color:white
