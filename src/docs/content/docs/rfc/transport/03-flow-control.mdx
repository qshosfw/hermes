...
graph TD
    ...
    classDef full fill:transparent,stroke:#ef4444,stroke-width:2px,color:inherit
    classDef normal fill:transparent,stroke:#89b4fa,stroke-width:2px,color:inherit
    class X full
    class A,R normal
```
...
graph LR
    ...
    classDef frag fill:transparent,stroke:#6366f1,stroke-width:2px,color:inherit
    classDef gap fill:transparent,stroke:#f59e0b,stroke-width:1px,stroke-dasharray:5 5,color:#f59e0b
