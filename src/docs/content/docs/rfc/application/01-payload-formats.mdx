...
# <Package className="inline w-6 h-6 mr-2 text-blue-400" /> 8. Payload Extensibility
...
> [!NOTE]
> Detailed specifications for ACKs have been moved to [**Application §9: Acknowledgments**](./07-acknowledgments).
