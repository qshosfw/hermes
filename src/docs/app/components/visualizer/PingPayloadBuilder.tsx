        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start gap-3 bg-neutral-900/50 p-3 rounded-lg border border-neutral-800">
                ...
                <div className="text-xs text-neutral-400 leading-relaxed">
                    <span className="font-semibold text-neutral-300">Payload Capacity:</span> The payload simulates the route trace stored during transit. Maximum capacity is 9 hops (54 bytes) + 2 bytes reserved. Currently using <span className="font-mono font-bold text-neutral-200">{hopPath.length * 6}</span> / 56 bytes.
                </div>
            </div>
        </div>
    );
