import { PacketHeaderConfig, AckedPacketInfo, PacketType, TelemetryPacketInfo, AckStatus } from '../types';
...
export const buildAckPacket = (
    ...
    if (ackedInfo.telemetryBit) {
        ...
        payload[32] = ((idleRssiVal & 0x1F) << 3) | ((ackedInfo.prevLqi >> 4) & 0x07);
...
export const parseAckPayload = (payload: Uint8Array): AckedPacketInfo => {
    ...
    if (telemetryBit) {
        ...
        info.idleRssi = fromRssiVal(idleRssiVal);
